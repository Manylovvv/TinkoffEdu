...
public class ControllerExceptionHandler {
    ...
    public ErrorResponse handleIncorrectRequest(IncorrectParametersException Exception) {
        return HandleOutput("There are incorrect parameters in your request!", Exception);
    }

    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleIncorrectRequest(MethodArgumentTypeMismatchException Exception) {
